...
const Login = () => {
  ...
  <p className="form-check-p ms-2" htmlFor="exampleCheck1 "> Reminder me</p>
  {/* <Link to='/forgot'> */}
  ...
  <Link  to={'/home'} type="submit " onClick={handlesubmit} className=" btn btn-primary" style={{width:"580px"}}>Login</Link>
  <div className='main-div  w-auto h-8 d-flex gap-16 mt-3 text-white ' style={{fontWeight:"bold"}}>
<div className= ' w-32 bg-green-500 pl-4 pt-1 whitespace-nowrap flex justify-center items-center' style={{borderRadius:"5px"}}>
    Super Admin
</div>
